...
class ProcesadorDatos:
    ...
    def crear_dataset_mensual(self, df_mensual):
        ...
        # Validación de precio unitario inteligente
...
def main():
    """Función principal para procesar datos y guardar Excel."""
    ...
    df_mensual_generado = procesador.crear_dataset_mensual(dataset)
    
    # Guardar a Excel
    df_mensual_generado.to_excel("dataset/dataset_mensual_generado.xlsx", index=False)
    print("✅ Dataset creado y guardado en 'dataset_mensual_generado.xlsx'")
